...
static VALUE sym_symbolize_keys, sym_as, sym_array, sym_struct, sym_database_timezone, sym_application_timezone,
          sym_local, sym_utc, sym_cast_booleans, sym_cast_dates_as_times, sym_cache_rows, sym_cast, sym_stream, sym_name;
...
static VALUE rb_mysql_result_each(int argc, VALUE * argv, VALUE self) {
  ...
  int symbolizeKeys, rowsAs, castBool, castDateAsTime, cacheRows, cast;
...
void init_mysql2_result() {
  ...
  sym_cast_dates_as_times   = ID2SYM(rb_intern("cast_datetimes"));
